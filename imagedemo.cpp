...
bool checkCollison(int Coinx,int Coiny){
	if(pic3_x+130>Coinx && pic3_y+330>Coiny ){
	   return true;
	}
	else{
	  return false;
    ...
    */
    ...
    else if (gameState ==0)
    {
        ...
        iText(10,553,"SCORE:", GLUT_BITMAP_HELVETICA_18);
            ...
            iSetColor(255,0,0);
            iFilledRectangle(550,550,flag*5,20);
			
		//eisob baler code kotha theke copy korso
        //char p[3];
        itoa(score,p,5);
        iText(100,553,p, GLUT_BITMAP_TIMES_ROMAN_24);
        writeScore(p);
    ...
    {
		//code copy korle esob e hoi bhujla
        char c[15];
        itoa(score,c,10);
...
int main()
{
    ...
    iSetTimer(.0000000003,life); //legend tumi bhai
